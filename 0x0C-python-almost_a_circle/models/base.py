...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """Returns a JSON representation of list"""
    ...
    def load_from_file_csv(cls):
        """Deserializes CSV format from a file.Returns: list of instances"""
    ...
    def draw(list_rectangles, list_squares):
        """Opens a Turtle window and draws rectangles and square"""
